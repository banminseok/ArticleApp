...
namespace DotNetNote.Models
{
    ...
    /// </summary>
    public class NoteRepositoryDapperDbContext : INoteRepository
    {
        private readonly DotNetNoteContext _context;
        private IConfiguration _config;
        //private SqlConnection con;
        private IDbConnection con; // SqlConnection에서 IDbConnection으로 변경
        private ILogger<NoteRepositoryDapperDbContext> _logger;
        private IMemoryCache _cache;

        /// <summary>
        /// 환경변수와 로그 개체 주입
        /// </summary>
        public NoteRepositoryDapperDbContext(
            IConfiguration config, ILogger<NoteRepositoryDapperDbContext> logger, IMemoryCache memoryCache)
        {
            _config = config;
